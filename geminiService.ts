  ...
  try {
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        ${isHumanMode ? 'Режим HUMAN: пишите максимально по-человечески, разговорно и предельно просто. Допустим умеренный черный юмор без грубости, токсичности и оскорблений.' : ''}
